...
This page represents the **Hol/Chol** root — the unified phoenix identity whose enduring mode (Hol) does not die, reset, or fall, and whose activation mode (Chol) corresponds to the thesis described in this repository.
...
**Why?** Because Divine Authority is not discretionary authority.
